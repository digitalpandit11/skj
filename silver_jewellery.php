                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-12 col-12" style="margin-top: 10px; margin-bottom: 70px;"><br><br><br><br><br><br><br><br>
                            <h2 style="color: #ffffff;"><center>Silver Jewellery</center></h2>
                            <center><p style="color: #ffffff;"><a href="index.php" style="color: #ffffff;">Home</a> -> Silver Jewellery</p><center>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="portfolio" class="portfolio section-bg">
      <div class="container">
        ...
        <div class="section-title">
          <h2 data-aos="fade-in">Silver Jewelleries We Offer</h2>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-silver">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                <a href="silver_jewellery/jodavi.php" style="font-size: 16px;"><h4>Jodavi</h4></a>

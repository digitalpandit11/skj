                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-12 col-12" style="margin-top: 10px; margin-bottom: 70px;"><br><br><br><br><br><br><br><br>
                            <h2 style="color: #ffffff;"><center>Ganpati Kan</center></h2>
                            <center><p style="color: #ffffff;"><a href="../index.php" style="color: #ffffff;">Home</a> -> <a href="../ganpati_jewellery.php" style="color: #ffffff;">Ganpati Jewellery</a> -> Ganpati Kan</p><center>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="portfolio" class="portfolio section-bg">
      <div class="container">
        ...
        <div class="section-title">
          <h2 data-aos="fade-in">Varieties of Ganpati Kan</h2>
        ...
        <div class="row portfolio-container" data-aos="fade-up">
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-links">
                <a href="../assets/img/ganapati_kan/ganapati-kan.webp" data-gall="portfolioGallery" class="venobox" title=""><i class="icofont-ui-zoom-in"></i></a>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="../assets/img/ganapati_kan/ganapati-kan2.webp" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="../assets/img/ganapati_kan/ganapati-kan2.webp" data-gall="portfolioGallery" class="venobox" title=""><i class="icofont-ui-zoom-in"></i></a>
              </div>
            </div>
          </div>
      </div>

                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-12 col-12" style="margin-top: 10px; margin-bottom: 70px;"><br><br><br><br><br><br><br><br>
                            <h2 style="color: #e0b238;"><center>Gents Ring</center></h2>
                            <center><p style="color: #e0b238;"><a href="../index.php">Home</a> -> <a href="../gold_jewellery.php">Gold Jewellery</a> -> Gents Rings</p><center>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="portfolio" class="portfolio section-bg">
      <div class="container">
        ...
        <div class="section-title">
          <h2 data-aos="fade-in">Varieties of Gents Ring</h2>
        ...
        <div class="row portfolio-container" data-aos="fade-up">
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-gents_rings">
            <div class="portfolio-wrap">
              <img src="../assets/img/gents/gentsring.webp" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="../assets/img/gents/gentsring.webp" data-gall="portfolioGallery" class="venobox" title=""><i class="icofont-ui-zoom-in"></i></a>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-gents_rings">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-links">
                <a href="../assets/img/gents/gentsring2.webp" data-gall="portfolioGallery" class="venobox" title=""><i class="icofont-ui-zoom-in"></i></a>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-gents_rings">
            <div class="portfolio-wrap">
              <img src="../assets/img/gents/gentsring3.webp" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="../assets/img/gents/gentsring3.webp" data-gall="portfolioGallery" class="venobox" title=""><i class="icofont-ui-zoom-in"></i></a>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-gents_rings">
            <div class="portfolio-wrap">
              <img src="../assets/img/gents/gentsring4.webp" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="../assets/img/gents/gentsring4.webp" data-gall="portfolioGallery" class="venobox" title=""><i class="icofont-ui-zoom-in"></i></a>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-gents_rings">
            <div class="portfolio-wrap">
              <img src="../assets/img/gents/gentsring5.webp" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="../assets/img/gents/gentsring5.webp" data-gall="portfolioGallery" class="venobox" title=""><i class="icofont-ui-zoom-in"></i></a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-gents_rings">
            <div class="portfolio-wrap">
              <img src="../assets/img/gents/gentsring6.webp" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="../assets/img/gents/gentsring6.webp" data-gall="portfolioGallery" class="venobox" title=""><i class="icofont-ui-zoom-in"></i></a>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-gents_rings">
            <div class="portfolio-wrap">
              <img src="../assets/img/gents/gentsring7.webp" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="../assets/img/gents/gentsring7.webp" data-gall="portfolioGallery" class="venobox" title=""><i class="icofont-ui-zoom-in"></i></a>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-gents_rings">
            <div class="portfolio-wrap">
              <img src="../assets/img/gents/gentsring8.webp" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="../assets/img/gents/gentsring8.webp" data-gall="portfolioGallery" class="venobox" title=""><i class="icofont-ui-zoom-in"></i></a>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-gents_rings">
            <div class="portfolio-wrap">
              <img src="../assets/img/gents/gentsring9.webp" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="../assets/img/gents/gentsring9.webp" data-gall="portfolioGallery" class="venobox" title=""><i class="icofont-ui-zoom-in"></i></a>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-gents_rings">
            <div class="portfolio-wrap">
              <img src="../assets/img/gents/gentsring10.webp" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="../assets/img/gents/gentsring10.webp" data-gall="portfolioGallery" class="venobox" title=""><i class="icofont-ui-zoom-in"></i></a>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-gents_rings">
            <div class="portfolio-wrap">
              <img src="../assets/img/gents/converted-gold_ring2.webp" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="../assets/img/gents/converted-gold_ring2.webp" data-gall="portfolioGallery" class="venobox" title=""><i class="icofont-ui-zoom-in"></i></a>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-gents_rings">
            <div class="portfolio-wrap">
              <img src="../assets/img/gents/converted-gold-ring.webp" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="../assets/img/gents/converted-gold-ring.webp" data-gall="portfolioGallery" class="venobox" title=""><i class="icofont-ui-zoom-in"></i></a>

                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-12 col-12" style="margin-top: 10px; margin-bottom: 70px;"><br><br><br><br><br><br><br><br>
                            <h2 style="color: #e0b238;"><center>Couple Ring</center></h2>
                            <center><p style="color: #e0b238;"><a href="../index.php">Home</a> -> <a href="../gold_jewellery.php">Gold Jewellery</a> -> Couple Ring</p><center>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="portfolio" class="portfolio section-bg">
      <div class="container">
        ...
        <div class="section-title">
          <h2 data-aos="fade-in">Varieties of Couple Ring</h2>
        ...
        <div class="row portfolio-container" data-aos="fade-up">
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-links">
                <a href="../assets/img/couple_ring/couple_ring.webp" data-gall="portfolioGallery" class="venobox" title=""><i class="icofont-ui-zoom-in"></i></a>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="../assets/img/couple_ring/couple_ring1.webp" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="../assets/img/couple_ring/couple_ring1.webp" data-gall="portfolioGallery" class="venobox" title=""><i class="icofont-ui-zoom-in"></i></a>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="../assets/img/couple_ring/couple_ring2.webp" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="../assets/img/couple_ring/couple_ring2.webp" data-gall="portfolioGallery" class="venobox" title=""><i class="icofont-ui-zoom-in"></i></a>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="../assets/img/couple_ring/couple_ring3.webp" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="../assets/img/couple_ring/couple_ring3.webp" data-gall="portfolioGallery" class="venobox" title=""><i class="icofont-ui-zoom-in"></i></a>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="../assets/img/couple_ring/couple_ring4.webp" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="../assets/img/couple_ring/couple_ring4.webp" data-gall="portfolioGallery" class="venobox" title=""><i class="icofont-ui-zoom-in"></i></a>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="../assets/img/couple_ring/couple_ring5.webp" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="../assets/img/couple_ring/couple_ring5.webp" data-gall="portfolioGallery" class="venobox" title=""><i class="icofont-ui-zoom-in"></i></a>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="../assets/img/couple_ring/couple_ring6.webp" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="../assets/img/couple_ring/couple_ring6.webp" data-gall="portfolioGallery" class="venobox" title=""><i class="icofont-ui-zoom-in"></i></a>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="../assets/img/couple_ring/couple_ring7.webp" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="../assets/img/couple_ring/couple_ring7.webp" data-gall="portfolioGallery" class="venobox" title=""><i class="icofont-ui-zoom-in"></i></a>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="../assets/img/couple_ring/couple_ring8.webp" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="../assets/img/couple_ring/couple_ring8.webp" data-gall="portfolioGallery" class="venobox" title=""><i class="icofont-ui-zoom-in"></i></a>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="../assets/img/couple_ring/couple_ring9.webp" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="../assets/img/couple_ring/couple_ring9.webp" data-gall="portfolioGallery" class="venobox" title=""><i class="icofont-ui-zoom-in"></i></a>

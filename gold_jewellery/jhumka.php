                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-12 col-12" style="margin-top: 10px; margin-bottom: 70px;"><br><br><br><br><br><br><br><br>
                            <h2 style="color: #e0b238;"><center>Jhumka</center></h2>
                            <center><p style="color: #e0b238;"><a href="../index.php">Home</a> -> <a href="../gold_jewellery.php">Gold Jewellery</a> -> Jhumka</p><center>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="portfolio" class="portfolio section-bg">
      <div class="container">
        ...
        <div class="section-title">
          <h2 data-aos="fade-in">Varieties of Jhumka</h2>
        ...
        <div class="row portfolio-container" data-aos="fade-up">
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-links">
                <a href="../assets/img/jhumka/jhumka.webp" data-gall="portfolioGallery" class="venobox" title=""><i class="icofont-ui-zoom-in"></i></a>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="../assets/img/jhumka/jhumka2.webp" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="../assets/img/jhumka/jhumka2.webp" data-gall="portfolioGallery" class="venobox" title=""><i class="icofont-ui-zoom-in"></i></a>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="../assets/img/jhumka/jhumka3.webp" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="../assets/img/jhumka/jhumka3.webp" data-gall="portfolioGallery" class="venobox" title=""><i class="icofont-ui-zoom-in"></i></a>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="../assets/img/jhumka/jhumka4.webp" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="../assets/img/jhumka/jhumka4.webp" data-gall="portfolioGallery" class="venobox" title=""><i class="icofont-ui-zoom-in"></i></a>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
              <img src="../assets/img/jhumka/jhumka5.webp" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="../assets/img/jhumka/jhumka5.webp" data-gall="portfolioGallery" class="venobox" title=""><i class="icofont-ui-zoom-in"></i></a>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              <img src="../assets/img/jhumka/jhumka6.webp" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="../assets/img/jhumka/jhumka6.webp" data-gall="portfolioGallery" class="venobox" title=""><i class="icofont-ui-zoom-in"></i></a>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="../assets/img/jhumka/jhumka7.webp" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="../assets/img/jhumka/jhumka7.webp" data-gall="portfolioGallery" class="venobox" title=""><i class="icofont-ui-zoom-in"></i></a>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
              <img src="../assets/img/jhumka/jhumka8.webp" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="../assets/img/jhumka/jhumka8.webp" data-gall="portfolioGallery" class="venobox" title=""><i class="icofont-ui-zoom-in"></i></a>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
              <img src="../assets/img/jhumka/jhumka9.webp" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="../assets/img/jhumka/jhumka9.webp" data-gall="portfolioGallery" class="venobox" title=""><i class="icofont-ui-zoom-in"></i></a>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
              <img src="../assets/img/jhumka/jhumka10.webp" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="../assets/img/jhumka/jhumka10.webp" data-gall="portfolioGallery" class="venobox" title=""><i class="icofont-ui-zoom-in"></i></a>
